...
void Resources::CreateDefaultShader()
{
	// Skybox
	{
		...
		shader->CreateGraphicsShader(L"..\\shader_SOURCE\\skybox.fx", info);
	...
	// Deferred (Deferred)
	{
		...
		shared_ptr<Shader> shader = make_shared<Shader>();
		shader->CreateGraphicsShader(L"..\\shader_SOURCE\\deferred.fx", info);
	...
	// Forward (Forward)
	{
		...
		shared_ptr<Shader> shader = make_shared<Shader>();
		shader->CreateGraphicsShader(L"..\\shader_SOURCE\\forward.fx", info);
	...
	// Texture (Forward)
	{
		...
		shared_ptr<Shader> shader = make_shared<Shader>();
		shader->CreateGraphicsShader(L"..\\shader_SOURCE\\forward.fx", info, arg);
	...
	// DirLight
	{
		...
		shared_ptr<Shader> shader = make_shared<Shader>();
		shader->CreateGraphicsShader(L"..\\shader_SOURCE\\lighting.fx", info, arg);
	...
	{
		shared_ptr<Shader> shader = make_shared<Shader>();
		shader->CreateComputeShader(L"..\\shader_SOURCE\\compute.fx", "CS_Main", "cs_5_0");
	...
	// Particle
	{
		...
		shared_ptr<Shader> shader = make_shared<Shader>();
		shader->CreateGraphicsShader(L"..\\shader_SOURCE\\particle.fx", info, arg);
	...
	{
		shared_ptr<Shader> shader = make_shared<Shader>();
		shader->CreateComputeShader(L"..\\shader_SOURCE\\particle.fx", "CS_Main", "cs_5_0");
	...
	// Shadow
	{
		...
		shared_ptr<Shader> shader = make_shared<Shader>();
		shader->CreateGraphicsShader(L"..\\shader_SOURCE\\shadow.fx", info);
	...
	// Tessellation
	{
		...
		shared_ptr<Shader> shader = make_shared<Shader>();
		shader->CreateGraphicsShader(L"..\\shader_SOURCE\\tessellation.fx", info, arg);
	...
	// Terrain
	{
		...
		shared_ptr<Shader> shader = make_shared<Shader>();
		shader->CreateGraphicsShader(L"..\\shader_SOURCE\\terrain.fx", info, arg);
	...
	{
		shared_ptr<Shader> shader = make_shared<Shader>();
		shader->CreateComputeShader(L"..\\shader_SOURCE\\animation.fx", "CS_Main", "cs_5_0");
